export default class ExamScreen {
  ...
  checkAnswer() {
    ...
    for (let i = 0; i < this.questionsList.length; i++) {
      if (
        this.questionsList[i]["your_answer"] != null &&
        this.questionsList[i]["your_answer"] ==
          this.questionsList[i]["answer"].charCodeAt(0) - "A".charCodeAt(0)
      ) {
        count++;
      }
    }
  ...
  async getScore() {
    ...
    if (score == 10) {
      ...
      this.container.innerHTML = `<div class='score-parent'>
                            ...
                            <div><img src='./fullmark.svg' class='score-svg'></div>`;
    } else {
      this.container.innerHTML = `<div class='score-parent'>
